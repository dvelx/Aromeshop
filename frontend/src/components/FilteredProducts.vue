    ...
    <form action="#" class="filter__form form" method="get">
      <fieldset class="form__block">
        ...
        <label class="form__label form__label--price">
          <input class="form__input" type="text" name="min-price" autocomplete="off">
          <span class="form__value">От</span>
        </label>
        <label class="form__label form__label--price">
          <input class="form__input" type="text" name="max-price" autocomplete="off">
...
.check-list {
  ...
  &__label:focus &__desc::after, &__label:hover &__desc::after {
    opacity: .3;
  }

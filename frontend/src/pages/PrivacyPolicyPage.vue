<template>
  <div class="container privacy-container">
    ...
    <p align="center">
      <strong>СОГЛАШЕНИЕ ОБ ОБРАБОТКЕ ПЕРСОНАЛЬНЫХ ДАННЫХ</strong>
    </p>
    <p>
      Мы рады приветствовать Вас на нашем сайте! Предлагаем Вашему вниманию соглашение об обработке персональных данных.
    </p>
    <p>
    ...
    <p>
      Если Вы считаете, что Соглашение или действия нас как Администрации Сайта нарушает Ваши права, не молчите, напишите нам об этом по электронному адресу: email@email.ru
    </p>
    <p align="center">
      <strong>1. Термины, применяемые в настоящем Соглашении:</strong>
    </p>
    <p>
      1.1. Сайт – это совокупность текстов, графических элементов, дизайна, изображений, программного кода, фото- и видеоматериалов и иных результатов интеллектуальной деятельности, содержащихся в сети Интернет под доменным именем aromehome.ru.
    </p>
    <p>
